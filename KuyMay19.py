...
def SettingOpt():
    ...
    # Muscle_var = ctk.StringVar(value="No")
    # Muscle = ctk.CTkOptionMenu(master = toplevel, values=["No", "Yes"],
    #                                     command=optionmenu_callback,
    #                                     variable=Muscle_var).place(relx=0.5, rely=.3)
    ...
    # Weight = ctk.CTkSlider(master = toplevel, from_=0, to=12, command=slider_event).place(relx=0.5, rely=.5, anchor = CENTER)
