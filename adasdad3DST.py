...
# Define colors, connections, etc. (as you have done)
...
# Create a function to display the 3D plot
def display_3d_plot(keypoints_3d, keypoint_connections):
...
# Streamlit app
def main():
    st.title("Pose Detection with MediaPipe and Streamlit")
    ...
    if st.button("asdasd"):
        ...
        while True:
            ...
            if results.pose_landmarks:
                ...
                # Display 3D plot
                display_3d_plot(keypoints_3d, keypoint_connections)
