    ...
    while True:
        ...
        if pose_results.pose_landmarks :
            ...
            if Tellside == 1:
              ...
              #step3
            #   left_wrist_angle = calculate_angle(Left_elbow_Pos, Left_wrist_Pos, Index_Tip, 'front')
            #   right_wrist_angle = calculate_angle(Right_elbow_Pos, Right_wrist_Pos, Index_Tip, 'front')
    ...
    while True:
        ...
        if pose_results.pose_landmarks :
            ...
            if Tellside == 1:
              ...
              #step3
              left_wrist_angle = 180-calculate_angle(Left_elbow_Pos, Left_wrist_Pos, Index_Tip, 'front')
              right_wrist_angle = 180-calculate_angle(Right_elbow_Pos, Right_wrist_Pos, Index_Tip, 'front')
